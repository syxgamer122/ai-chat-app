...
export const TOOL_CATALOG: readonly ToolCatalogEntry[] = [
  ...
  // memory
  {
    ...
    description: 'Tìm kiếm toàn bộ lịch sử các phiên trò chuyện trước đây để tra cứu thông tin cũ.',
  ...
  },
  {
    ...
    description: 'Xoá toàn bộ memory của một category khi người dùng yêu cầu rõ ràng.',
    aliases: [],
    desktopOnly: false,
  },
  {
    ...
    description: 'Xoá đúng một entry memory theo id.',
    aliases: [],
    desktopOnly: false,
  },
  {
