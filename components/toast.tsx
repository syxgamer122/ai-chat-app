...
export function Toast({ message, onClose }: ToastProps) {
  ...
  return (
    ...
    >
      <div className="notice-warn pointer-events-auto flex max-w-md items-start gap-2.5 bg-amber-50/95 shadow-card backdrop-blur animate-slide-up">
        ...
        <button
          ...
          className="-mr-1 -mt-0.5 flex-shrink-0 rounded p-0.5 text-amber-700/70 transition-colors hover:bg-amber-100 hover:text-amber-900"
        >
          <X size={13} />
        </button>
      </div>
