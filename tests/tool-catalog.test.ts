...
/** 24 tên mong đợi, viết tường minh để bắt cả thêm lẫn xoá tool một cách vô ý. */
...
describe('TOOL_CATALOG - đủ 24 tool, không thừa không thiếu', () => {
  it('tập tên khớp đúng 24 tên mong đợi', () => {
  ...
  it('kind: đúng 6 server + 18 client', () => {
